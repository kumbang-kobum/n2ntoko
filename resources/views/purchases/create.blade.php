<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-semibold text-gray-800">Buat Pembelian</h2>
        </div>
    </x-slot>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-amber-600 mt-1">
                                Belum ada supplier.
                                <a href="{{ route('suppliers.index') }}" target="_blank" class="underline">Tambahkan dulu →</a>
                            </p>
                            @endif
                        </div>
                        <div>
